...
class HabitsDashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = findViewById<RecyclerView>(R.id.recyclerView_habits_dashboard)
        recyclerView.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))
        recyclerView.layoutManager = LinearLayoutManager(this)
        recyclerView.adapter = HabitsAdapter(data)
    ...
    fun revealAdHabitActivity(){
        ...
        val startRadius = 0
        val endingRadius = Math.hypot(coordinatorLayout_main.width.toDouble(), coordinatorLayout_main.height.toDouble())
